{{-- Line Items Builder --}}
{{-- Usage: @include('crm.partials.line-items', ['items' => $existing]) --}}
<div x-data="lineItems(@json($items ?? []))" class="crm-card" style="overflow:visible;">
        ...
        <table class="crm-table" style="min-width:600px;">
            ...
            <template x-for="(row, idx) in rows" :key="idx">
                <tr>
                    ...
                    <td style="font-weight:500;color:var(--color-ink-1);" x-text="'R ' + row.line_total.toFixed(2)"></td>
                    <td>
    ...
    <div class="crm-card-footer" style="display:flex;justify-content:flex-end;">
        <div style="min-width:220px;">
            <div class="crm-detail-row">
                ...
                <span class="crm-detail-value" x-text="'R ' + subtotal().toFixed(2)"></span>
            </div>
